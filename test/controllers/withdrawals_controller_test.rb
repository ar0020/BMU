...
class WithdrawalsControllerTest < ActionController::TestCase
  ...
  test "should create withdrawal" do
    assert_difference('Withdrawal.count') do
      post :create, withdrawal: { account_id: @withdrawal.account_id, amount: @withdrawal.amount, description: @withdrawal.description, transaction_type: @withdrawal.transaction_type, user_id: @withdrawal.user_id }
    end
  ...
  test "should update withdrawal" do
    patch :update, id: @withdrawal, withdrawal: { account_id: @withdrawal.account_id, amount: @withdrawal.amount, description: @withdrawal.description, transaction_type: @withdrawal.transaction_type, user_id: @withdrawal.user_id }
    assert_redirected_to withdrawal_path(assigns(:withdrawal))
  end

...
class DepositsControllerTest < ActionController::TestCase
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post :create, deposit: { account_id: @deposit.account_id, amount: @deposit.amount, description: @deposit.description, transaction_type: @deposit.transaction_type, user_id: @deposit.user_id }
    end
  ...
  test "should update deposit" do
    patch :update, id: @deposit, deposit: { account_id: @deposit.account_id, amount: @deposit.amount, description: @deposit.description, transaction_type: @deposit.transaction_type, user_id: @deposit.user_id }
    assert_redirected_to deposit_path(assigns(:deposit))
  end
